...
var _mainHeaderTemplate = require("./components/main/header/main_header_template");
var _mainHeaderTemplateDefault = parcelHelpers.interopDefault(_mainHeaderTemplate);
var _api = require("./js/API/api");
// Test!  for delete !!!!!
const fetchTrendingMovies = async ()=>{
    const { data  } = await (0, _api.getTrendingMovies)();
    console.log(data);
};
const fetchMovie = async (id)=>{
    const { data  } = await (0, _api.getMovie)(id);
    console.log(data);
};
const fetchSearchingMovie = async (search)=>{
    const { data  } = await (0, _api.getSearchingMovie)(search);
    console.log(data);
};
fetchTrendingMovies();
fetchMovie(675353);
...
document.querySelector(".container").insertAdjacentHTML("afterbegin", (0, _mainHeaderTemplateDefault.default)());

},{"./components/main/header/main_header_template":"h48hK","./js/API/api":"c7ya5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h48hK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function mainHeaderTemplate() {
    return `<div class="main__header">
        ...
        <div class="main__header-input">
          ...
          <img src="${0, _searchSvgDefault.default}" alt="" />
        </div>
      </div>`;
}
exports.default = mainHeaderTemplate;

},{"../../../images/search.svg":"eapLF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eapLF":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "search.8332d073.svg" + "?" + Date.now();
...
},{}],"c7ya5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getTrendingMovies", ()=>getTrendingMovies);
parcelHelpers.export(exports, "getSearchingMovie", ()=>getSearchingMovie);
parcelHelpers.export(exports, "getMovie", ()=>getMovie);
...
// Links
const urlTrendingMovies = (pageNumber)=>URL + trendingMovies + KEYv3 + pagination(pageNumber);
const urlSearchingMovie = (inputText)=>URL + searchingMovie + KEYv3 + query(inputText);
const urlMovie = (id)=>URL + movie + id + KEYv3;
const getTrendingMovies = async (pageNumber = 1)=>await (0, _axiosDefault.default).get(urlTrendingMovies(pageNumber));
const getSearchingMovie = async (inputText)=>await (0, _axiosDefault.default).get(urlSearchingMovie(inputText));
const getMovie = async (id)=>await (0, _axiosDefault.default).get(urlMovie(id));
...
},{"./../utils":"5By4s"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired76b")
